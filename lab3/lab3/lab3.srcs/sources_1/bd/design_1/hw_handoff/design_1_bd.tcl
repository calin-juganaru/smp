...
# module references:
# CS_split, mpc106fsm, powerpcfsm, splitter, x2mx9_sdramfsm
...
proc create_root_design { parentCell } {
  ...
  # Create instance: CS_split_0, and set properties
  set block_name CS_split
  set block_cell_name CS_split_0
  if { [catch {set CS_split_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $CS_split_0 eq "" } {
  ...
  # Create instance: x2mx9_sdramfsm_0, and set properties
  set block_name x2mx9_sdramfsm
  set block_cell_name x2mx9_sdramfsm_0
  if { [catch {set x2mx9_sdramfsm_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $x2mx9_sdramfsm_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create port connections
  connect_bd_net -net CLK_0_1 [get_bd_ports CLK_0] [get_bd_pins mpc106fsm_0/CLK] [get_bd_pins powerpcfsm_0/CLK] [get_bd_pins x2mx9_sdramfsm_0/CLK]
  connect_bd_net -net CS_split_0_CS_bit [get_bd_pins CS_split_0/CS_bit] [get_bd_pins x2mx9_sdramfsm_0/CS]
  ...
  connect_bd_net -net mpc106fsm_0_CS [get_bd_pins CS_split_0/CS] [get_bd_pins mpc106fsm_0/CS]
  connect_bd_net -net mpc106fsm_0_DBG0 [get_bd_pins mpc106fsm_0/DBG0] [get_bd_pins powerpcfsm_0/DBG]
  connect_bd_net -net mpc106fsm_0_DH [get_bd_pins mpc106fsm_0/DH] [get_bd_pins powerpcfsm_0/DH] [get_bd_pins splitter_0/DH]
  connect_bd_net -net mpc106fsm_0_SDCAS [get_bd_pins mpc106fsm_0/SDCAS] [get_bd_pins x2mx9_sdramfsm_0/CAS]
  connect_bd_net -net mpc106fsm_0_SDMA [get_bd_pins mpc106fsm_0/SDMA] [get_bd_pins x2mx9_sdramfsm_0/A]
  connect_bd_net -net mpc106fsm_0_SDRAS [get_bd_pins mpc106fsm_0/SDRAS] [get_bd_pins x2mx9_sdramfsm_0/RAS]
  connect_bd_net -net mpc106fsm_0_TA [get_bd_pins mpc106fsm_0/TA] [get_bd_pins powerpcfsm_0/TA]
  connect_bd_net -net mpc106fsm_0_WE [get_bd_pins mpc106fsm_0/WE] [get_bd_pins x2mx9_sdramfsm_0/WE]
  ...
  connect_bd_net -net splitter_0_DQ [get_bd_pins splitter_0/DQ] [get_bd_pins x2mx9_sdramfsm_0/DQ]
