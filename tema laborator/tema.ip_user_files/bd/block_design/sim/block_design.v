...
module block_design
   (CLK_0);
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK_0 CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK_0, CLK_DOMAIN block_design_CLK_0, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.000" *) input CLK_0;

  wire CLK_0_1;
  wire MUX_0_OUTP;
  wire microcontrolor_0_CS1;
  wire microcontrolor_0_CS2;
  ...
  block_design_ecran_2_0_0 ecran_2_0
       (.SCL(microcontrolor_0_SCL),
        .SDA(microcontrolor_0_SDA));
  block_design_microcontrolor_0_1 microcontrolor_0
       (.CLK(CLK_0_1),
        .CS1(microcontrolor_0_CS1),
        .CS2(microcontrolor_0_CS2),
        .MISO(MUX_0_OUTP),
