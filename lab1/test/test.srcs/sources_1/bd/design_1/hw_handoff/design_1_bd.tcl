...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net Net2 [get_bd_pins core_logic_0/ad_stb0] [get_bd_pins graphic_controller_0/ad_stb0]
  connect_bd_net -net Net3 [get_bd_pins core_logic_0/ad_stb1] [get_bd_pins graphic_controller_0/ad_stb1]
  connect_bd_net -net clk_1 [get_bd_ports clk] [get_bd_pins core_logic_0/clk] [get_bd_pins graphic_controller_0/clk]
