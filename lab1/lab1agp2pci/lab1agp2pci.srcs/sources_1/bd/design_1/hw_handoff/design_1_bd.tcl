...
proc create_root_design { parentCell } {
  ...
  set irdy_0 [ create_bd_port -dir I irdy_0 ]
  set irdy_1 [ create_bd_port -dir IO irdy_1 ]
  set rst_0 [ create_bd_port -dir IO -type rst rst_0 ]
  set rst_1 [ create_bd_port -dir IO -type rst rst_1 ]
  set trdy_0 [ create_bd_port -dir O trdy_0 ]
  set trdy_1 [ create_bd_port -dir IO trdy_1 ]
  ...
  connect_bd_net -net Net2 [get_bd_ports clk] [get_bd_pins core_logic_0/clk] [get_bd_pins graphic_controller_0/clk]
  ...
  connect_bd_net -net Net5 [get_bd_ports irdy_1] [get_bd_pins graphic_controller_0/irdy]
  connect_bd_net -net Net6 [get_bd_ports trdy_1] [get_bd_pins graphic_controller_0/trdy]
  connect_bd_net -net Net7 [get_bd_ports rst_0] [get_bd_pins core_logic_0/rst]
  connect_bd_net -net Net8 [get_bd_ports rst_1] [get_bd_pins graphic_controller_0/rst]
  ...
  connect_bd_net -net core_logic_0_trdy [get_bd_ports trdy_0] [get_bd_pins core_logic_0/trdy]
  ...
  connect_bd_net -net irdy_0_1 [get_bd_ports irdy_0] [get_bd_pins core_logic_0/irdy]
